...
use Whoops\Handler\PrettyPageHandler; // For pretty error handling
use Whoops\Run; // Whoops main class
use Monolog\Logger;
...
// Initialize Whoops for error handling in development
$whoops = new Run;
...
$logger->pushHandler(new StreamHandler(__DIR__ . '/../logs/app.log', Logger::INFO)); // Log to a file
...
try {
    ...
    // Handle any exceptions that were not caught
